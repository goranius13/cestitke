...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <meta charset="utf-8">
        <meta name="description" content="Čestitke Online">
        <meta name="keywords" content="čestitke, online, cestitke, cestitkeonline, cestitke.online, vjenčanje, rođendan, krštenje, krizma, blagdani">
        ...
        <section class="hero">
            <div class="hero-body p-0">
                ...
                <figure class="image mx-4">
                    <img class="main-banner" src="/images/banermobile.png" srcset="/images/banermobile.png 1024w, /images/baner.jpg 2000w">
                </figure>
                </div>
            </div>
        </section>
